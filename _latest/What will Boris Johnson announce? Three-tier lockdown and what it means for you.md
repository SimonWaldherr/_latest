...
title: > 
  What will Boris Johnson announce? Three-tier lockdown and what it means for you 
description: > 
  He is expected to unveil a three-tier local lockdown system.At the moment, more than 50 areas in England are under a confusing array of local lockdown rules.However, there might still be some specific measures for local areas even on top of what's being announced.Tier 3 is for the highest-risk areas, and is expected to go much further than the current local lockdown rules.For now, you can search the lockdown rules for your area below. 
date: 1602460572.807523 
--- 
