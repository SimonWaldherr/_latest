...
title: > 
  eBay takes a bite at StockX and GOAT with sneaker authentication for sales $100+ in the U.S. – TechCrunch 
description: > 
  eBay is announcing today that it’s going to start authenticating sneaker sales over $100 in the U.S.This is a clear bite into the dominance of StockX and GOAT in the limited sneaker universe.The authentication will be done by Sneaker Con, the company that runs, well, Sneaker Con.Proof of Authentication : Upon receiving the sneakers, the independent authenticator confirmsthey are consistent with the listing title, description, and images, and then performs a multi-pointphysical authentication inspection.The eBay authentication tags even look like those offered by the two players. 
date: 1602536876.3237314 
--- 
